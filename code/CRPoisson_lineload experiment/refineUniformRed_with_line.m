...
%       defined by c4nNew, n4eNew, n4sDbNew and n4sNbNew.
    ...
    n4sSlitNew = zeros(2*nr_sidesSlit,2);
    for curSide = 1 : size(n4sSlit,1)
        curNodes = n4sSlit(curSide,:);
        curNewNodes = newNodes4s(curNodes(1),curNodes(2));
        % Generate new Slit sides.
        n4sSlitNew(2*(curSide-1)+1:2*curSide,:) = ...
                  [ curNodes(1)    curNewNodes;
                    curNewNodes    curNodes(2);
                  ];  
    end

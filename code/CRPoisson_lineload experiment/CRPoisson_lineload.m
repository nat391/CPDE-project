function CRPoisson_lineload(geometry, nodes_line, max_level, lineload, degree, OPTname)
...
scaling1 = error4lvl(max_level) / (ndof4lvl(max_level)^(-0.25)) * 1.4;
scaling2 = error4lvl_jumpterm(max_level) / (ndof4lvl(max_level)^(-1/3)) * 1.3;
